...
export const socials = {
  behance: {
    ...
    regex: new RegExp(String.raw`https://behance.net/([\w_.-]+)`),
  ...
  codecademy: {
    ...
    regex: new RegExp(String.raw`https://codecademy.com/profiles/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'codecademy',
    icon: Logocodecademy,
  },
  codepen: {
    ...
    regex: new RegExp(String.raw`https://codepen.io/([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  coderwall: {
    ...
    regex: new RegExp(String.raw`https://coderwall.com/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'coderwall',
    icon: Logocoderwall,
  },
  ...
  disqus: {
    ...
    regex: new RegExp(String.raw`https://disqus.com/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'disqus',
    icon: Logodisqus,
  },
  ...
  flickr: {
    ...
    regex: new RegExp(String.raw`https://flickr.com/people/([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  gitlab: {
    ...
    regex: new RegExp(String.raw`https://gitlab.com/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'gitlab',
    icon: Logogitlab,
  },
  ...
  gravatar: {
    ...
    regex: new RegExp(String.raw`http://en.gravatar.com/(((?!\.).)*)`),
    usernameIsValid: (username: string) => {
      try {
        new RegExp(String.raw`^((?!\.).)*$`).test(username);
      } catch {
        return false;
      }
    },
  ...
  hashnode: {
    ...
    regex: new RegExp(String.raw`https://hashnode.com/@([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  instagram: {
    ...
    regex: new RegExp(String.raw`https://instagram.com/([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  linkedin: {
    ...
    regex: new RegExp(String.raw`https://linkedin.com/in/([\w._-]+)`),
    usernameIsValid: (username: string) => {
      try {
        new RegExp(String.raw`^[\w._-]+$`).test(username);
      } catch {
        return false;
      }
    },
  ...
  medium: {
    ...
    regex: new RegExp(String.raw`https://medium.com/@([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  opensource: {
    ...
    regex: new RegExp(String.raw`https://opensource.com/users/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'opensource',
    icon: Logoopensource,
  },
  patreon: {
    ...
    regex: new RegExp(String.raw`https://patreon.com/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'patreon',
    icon: Logopatreon,
  },
  periscope: {
    ...
    regex: new RegExp(String.raw`https://periscope.tv/([\w_.-]+)/`),
    usernameIsValid: () => true,
    iconName: 'periscope',
    icon: Logoperiscope,
  },
  producthunt: {
    ...
    regex: new RegExp(String.raw`https://producthunt.com/@([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  pypi: {
    ...
    regex: new RegExp(String.raw`https://pypi.org/user/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'pypi',
    icon: Logopypi,
  },
  reddit: {
    ...
    regex: new RegExp(String.raw`https://reddit.com/user/([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  scribd: {
    ...
    regex: new RegExp(String.raw`https://scribd.com/([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  signal: {
    ...
    regex: new RegExp(String.raw`https://community.signalusers.org/u/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'signal',
    icon: Logosignal,
  },
  ...
  slides: {
    ...
    regex: new RegExp(String.raw`https://slides.com/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'slides',
    icon: Logoslides,
  },
  soundcloud: {
    ...
    regex: new RegExp(String.raw`https://soundcloud.com/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'soundcloud',
    icon: Logosoundcloud,
  },
  spotify: {
    ...
    regex: new RegExp(String.raw`https://open.spotify.com/user/([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  trello: {
    ...
    regex: new RegExp(String.raw`https://trello.com/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'trello',
    icon: Logotrello,
  },
  ...
  vimeo: {
    ...
    regex: new RegExp(String.raw`https://vimeo.com/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'vimeo-icon',
    icon: Logovimeo,
  },
  ...
  wix: {
    ...
    regex: new RegExp(String.raw`https://([\w@-]+?).wix.com`),
    usernameIsValid: (username: string) => {
      try {
        new RegExp(String.raw`^[\w@-]+?$`).test(username);
      } catch {
        return false;
      }
    },
  ...
  youtube: {
    ...
    regex: new RegExp(String.raw`https://youtube.com/@([\w_.-]+)`),
    usernameIsValid: () => true,
  ...
  lastfm: {
    ...
    regex: new RegExp(String.raw`https://last.fm/user/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'lastfm',
    icon: Logolastfm,
  },
  npm: {
    ...
    regex: new RegExp(String.raw`https://npmjs.com/~([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'npm-icon',
    icon: Logonpm,
  },
  bluesky: {
    ...
    regex: new RegExp(String.raw`https://bsky.app/profile/([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'bluesky',
    icon: Logobluesky,
  },
  wakatime: {
    ...
    regex: new RegExp(String.raw`https://wakatime.com/@([\w_.-]+)`),
    usernameIsValid: () => true,
    iconName: 'wakatime',
    icon: Logowakatime,
  },
