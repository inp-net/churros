...
const PAGES = {
  ...
  "/announcements/[pseudoId]/edit": (pseudoId: (string | number), params?: {  }) => {
    return `/announcements/${pseudoId}/edit`
  },
  ...
  "/events/[group]/[uid]/book/[ticket]": (params: { group: (string | number), uid: (string | number), ticket: (string | number) }) => {
  ...
  "/events/[group]/[uid]/registrations": (params: { group: (string | number), uid: (string | number) }) => {
  ...
  "/groups/[uid]/shop/[itemUid]/edit": (params: { uid: (string | number), itemUid: (string | number) }) => {
  ...
  "/posts/[group]/create": (group: (string | number), params?: {  }) => {
    return `/posts/${group}/create`
  },
...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/announcements': never, '/announcements/[pseudoId]/edit': 'pseudoId', '/announcements/create': never, '/backrooms': never, '/backrooms/services': never, '/bar-weeks': never, '/birthdays': never, '/boards': never, '/bookings': never, '/bookings/[pseudoID]': 'pseudoID', '/changelog': never, '/claim-code': never, '/claim-code/[code]': 'code', '/credits': never, '/documents': never, '/documents/[major]': 'major', '/documents/[major]/[yearTier=display_year_tier]': 'major' | 'yearTier', '/documents/[major]/[yearTier=display_year_tier]/[subject]': 'major' | 'yearTier' | 'subject', '/documents/[major]/[yearTier=display_year_tier]/[subject]/[document]': 'major' | 'yearTier' | 'subject' | 'document', '/documents/[major]/[yearTier=display_year_tier]/[subject]/[document]/edit': 'major' | 'yearTier' | 'subject' | 'document', '/documents/[major]/[yearTier=display_year_tier]/[subject]/create': 'major' | 'yearTier' | 'subject', '/documents/create': never, '/events': 'week', '/events/[group]/[uid]': 'group' | 'uid', '/events/[group]/[uid]/book/[ticket]': 'group' | 'uid' | 'ticket', '/events/[group]/[uid]/edit': 'group' | 'uid', '/events/[group]/[uid]/registrations': 'group' | 'uid', '/events/[group]/[uid]/scan': 'group' | 'uid', '/events/[group]/[uid]/write': 'group' | 'uid', '/events/[group]/create': 'group', '/events/create': never, '/forms': never, '/forms/[form]/answer': 'form' | 'section', '/forms/[form]/answered': 'form', '/forms/[form]/answers': 'form', '/forms/[form]/answers/analytics': 'form', '/forms/[form]/edit': 'form', '/forms/create': never, '/groups': never, '/groups/[uid]': 'uid', '/groups/[uid]/[...page]': 'uid' | 'page', '/groups/[uid]/edit': 'uid', '/groups/[uid]/edit/bank-accounts': 'uid', '/groups/[uid]/edit/members': 'uid', '/groups/[uid]/edit/members/bulk': 'uid', '/groups/[uid]/edit/pages': 'uid', '/groups/[uid]/edit/pages/[...page]': 'uid' | 'page', '/groups/[uid]/members': 'uid', '/groups/[uid]/shop': 'uid', '/groups/[uid]/shop/[itemUid]': 'uid' | 'itemUid', '/groups/[uid]/shop/[itemUid]/edit': 'uid' | 'itemUid', '/groups/[uid]/shop/create': 'uid', '/groups/[uid]/shop/orders': 'uid', '/groups/[uid]/shop/sales': 'uid', '/groups/[uid]/shop/sales/[itemUid]': 'uid' | 'itemUid', '/groups/[uid]/subgroups/create': 'uid', '/help': never, '/login': never, '/login/forgotten': never, '/login/reset/[token]': 'token', '/logs': never, '/notifications': never, '/posts/[group]/[uid]': 'group' | 'uid', '/posts/[group]/[uid]/edit': 'group' | 'uid', '/posts/[group]/create': 'group', '/posts/create': never, '/quick-signups/create': never, '/quick-signups/manage': never, '/quick-signups/qr/[code]': 'code', '/register': 'quickSignupCode', '/register/continue': never, '/reports': never, '/reports/[number]': 'number', '/schools/[uid]': 'uid', '/schools/[uid]/edit': 'uid', '/search': 'q', '/services': never, '/services/[id]/edit': 'id', '/services/create': never, '/services/submit': never, '/set-password': never, '/signups': never, '/signups/edit/[email]': 'email', '/student-associations/[uid]': 'uid', '/student-associations/[uid]/[...page]': 'uid' | 'page', '/student-associations/[uid]/edit/pages': 'uid', '/student-associations/[uid]/edit/pages/[...page]': 'uid' | 'page', '/users/[uid]': 'uid', '/users/[uid]/edit': 'uid', '/validate-email/[token]': 'token', '/welcome': never, '/authorize': never, '/connect/google/callback': never, '/kiosk': never, '/_component/[...componentName]': 'componentName', '/developers/apps': never, '/developers/apps/[id]': 'id', '/developers/apps/create': never }
  SERVERS: { 'GET /[entity=entity_handle]': 'entity', 'GET /bookings/[pseudoID].pdf': 'pseudoID', 'GET /events/feed': never, 'GET /events/planning': never, 'GET /events/week/[monday]': 'monday', 'GET /forms/[form]/answers.[extension]': 'form' | 'extension', 'GET /frappe': never, 'GET /groups/[uid].pdf': 'uid', 'GET /help/prefilled-links': never, 'GET /logout': never, 'GET /me': never, 'GET /connect/google': never, 'GET /health': never, 'GET /identity': never, 'GET /check-uid/[uid]': 'uid', 'GET /developers': never, 'POST /markdown': never }
  ACTIONS: { 'upsertForm /forms': never, 'postAnswers /forms/[form]/answer': 'form' | 'section', 'upsertSection /forms/[form]/edit': 'form' }
  LINKS: Record<string, never>
  Params: { pseudoId: never, pseudoID: never, code: never, major: never, yearTier: never, subject: never, document: never, week: never, group: never, uid: never, ticket: never, form: never, section: never, page: never, itemUid: never, token: never, quickSignupCode: never, number: never, q: never, id: never, email: never, componentName: never, entity: never, monday: never, extension: never }
}
