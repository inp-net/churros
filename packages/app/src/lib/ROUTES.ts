...
const PAGES = {
  "/": `/`,
  "/[uid=uid]": (uid: (Parameters<typeof import('../params/uid.ts').match>[0]), params?: { tab?: ("infos" | "members" | "family" | "see-also" | "groups" | "services" | "majors" | "subjects" | "boards") }) => {
    params = params ?? {}
    params.tab = params.tab ?? "infos"; 
    return `/${uid}${appendSp({ tab: params.tab })}`
  },
  "/[uid=uid]/[...page]": (params: { uid: (Parameters<typeof import('../params/uid.ts').match>[0]), page: (string | number)[] }) => {
  ...
  "/events/[id]/bookings": (id: (string | number), params?: { tab?: ("unpaid" | "paid" | "verified") }) => {
    params = params ?? {}
  ...
  "/events/[id]/edit/ticket-groups/[group]": (params: { id: (string | number), group: (string | number) }) => {
  ...
  "/events/[id]/edit/tickets/[ticket]": (params: { id: (string | number), ticket: (string | number) }) => {
    return `/events/${params.id}/edit/tickets/${params.ticket}`
  },
  "/events/[id]/edit/tickets/[ticket]/counting": (params: { id: (string | number), ticket: (string | number) }) => {
    return `/events/${params.id}/edit/tickets/${params.ticket}/counting`
  },
  "/events/[id]/edit/tickets/[ticket]/group": (params: { id: (string | number), ticket: (string | number) }) => {
    return `/events/${params.id}/edit/tickets/${params.ticket}/group`
  },
  "/events/[id]/edit/tickets/[ticket]/links": (params: { id: (string | number), ticket: (string | number) }) => {
    return `/events/${params.id}/edit/tickets/${params.ticket}/links`
  },
  "/events/[id]/edit/tickets/[ticket]/payment": (params: { id: (string | number), ticket: (string | number) }) => {
...
const SERVERS = {
  ...
  "GET /[uid=uid].png": (uid: (Parameters<typeof import('../params/uid.ts').match>[0]), params?: {  }) => {
    return `/${uid}.png`
  },
...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/[uid=uid]': 'uid', '/[uid=uid]/[...page]': 'uid' | 'page', '/announcements': never, '/announcements/[id]/edit': 'id', '/announcements/create': never, '/backrooms': never, '/bar-weeks': never, '/birthdays': never, '/bookings': never, '/bookings/[code]': 'code', '/changelog': never, '/claim-code': never, '/claim-code/[code]': 'code', '/credits': never, '/documents': never, '/documents/[major]': 'major', '/documents/[major]/[yearTier=display_year_tier]': 'major' | 'yearTier', '/documents/[major]/[yearTier=display_year_tier]/[subject]': 'major' | 'yearTier' | 'subject', '/documents/[major]/[yearTier=display_year_tier]/[subject]/[document]': 'major' | 'yearTier' | 'subject' | 'document', '/documents/[major]/[yearTier=display_year_tier]/[subject]/[document]/edit': 'major' | 'yearTier' | 'subject' | 'document', '/documents/[major]/[yearTier=display_year_tier]/[subject]/create': 'major' | 'yearTier' | 'subject', '/documents/create': never, '/events': 'week', '/events/[id]': 'id', '/events/[id]/bookings': 'id', '/events/[id]/edit': 'id', '/events/[id]/edit/banned': 'id', '/events/[id]/edit/contact': 'id', '/events/[id]/edit/description': 'id', '/events/[id]/edit/image': 'id', '/events/[id]/edit/links': 'id', '/events/[id]/edit/managers': 'id', '/events/[id]/edit/recurrence': 'id', '/events/[id]/edit/ticket-groups/[group]': 'id' | 'group', '/events/[id]/edit/tickets': 'id', '/events/[id]/edit/tickets/[ticket]': 'id' | 'ticket', '/events/[id]/edit/tickets/[ticket]/counting': 'id' | 'ticket', '/events/[id]/edit/tickets/[ticket]/group': 'id' | 'ticket', '/events/[id]/edit/tickets/[ticket]/links': 'id' | 'ticket', '/events/[id]/edit/tickets/[ticket]/payment': 'id' | 'ticket', '/events/[id]/edit/visibility': 'id', '/events/[id]/scan': 'id', '/groups/[uid]/edit': 'uid', '/groups/[uid]/edit/bank-accounts': 'uid', '/groups/[uid]/edit/bio': 'uid', '/groups/[uid]/edit/links': 'uid', '/groups/[uid]/edit/members': 'uid', '/groups/[uid]/edit/members/bulk': 'uid', '/groups/[uid]/edit/pages': 'uid', '/groups/[uid]/edit/pages/[...page]': 'uid' | 'page', '/groups/[uid]/edit/type': 'uid', '/groups/[uid]/members': 'uid', '/help': never, '/login': never, '/login/done': never, '/login/forgotten': never, '/login/reset/[token]': 'token', '/logout': never, '/logs': never, '/notifications': never, '/posts/create': 'group', '/posts/[id]': 'id', '/posts/[id]/edit': 'id', '/quick-signups/create': never, '/quick-signups/manage': never, '/quick-signups/qr/[code]': 'code', '/reports': never, '/reports/[number]': 'number', '/search': 'q', '/services': never, '/services/[id]/edit': 'id', '/services/manage': never, '/services/submit': never, '/set-password': never, '/settings': never, '/signups': never, '/signups/edit/[email]': 'email', '/student-associations/[uid]/[...page]': 'uid' | 'page', '/student-associations/[uid]/edit/pages': 'uid', '/student-associations/[uid]/edit/pages/[...page]': 'uid' | 'page', '/users/[uid]/edit': 'uid', '/users/[uid]/edit/bio': 'uid', '/users/[uid]/edit/contributions': 'uid', '/users/[uid]/edit/curriculum': 'uid', '/users/[uid]/edit/email': 'uid', '/users/[uid]/edit/family': 'uid', '/users/[uid]/edit/links': 'uid', '/users/[uid]/edit/name': 'uid', '/users/[uid]/edit/other-emails': 'uid', '/users/[uid]/edit/permissions': 'uid', '/validate-email/[token]': 'token', '/welcome': never, '/connect/google/callback': never, '/kiosk': never, '/_component/[...componentName]': 'componentName', '/signup': never, '/signup/[qrcode]': 'qrcode', '/signup/finish/[token]': 'token' }
  SERVERS: { 'GET /[entity=entity_handle]': 'entity', 'GET /[uid=uid].png': 'uid', 'GET /bookings/[code].pdf': 'code', 'GET /events/[id]/bookings.csv': 'id', 'GET /frappe': never, 'GET /groups/[uid]': 'uid', 'GET /groups/[uid].pdf': 'uid', 'GET /groups/[uid]/[...page]': 'uid' | 'page', 'GET /groups/[uid]/handover.pdf': 'uid', 'GET /help/prefilled-links': never, 'GET /me': never, 'GET /schools/[uid]': 'uid', 'GET /student-associations/[uid]': 'uid', 'GET /themes.css': never, 'GET /users/[uid]': 'uid', 'GET /connect/google': never, 'GET /health': never, '_RESERVED_USERNAMES /check-uid/[uid]': 'uid', 'GET /check-uid/[uid]': 'uid', 'GET /gdpr': never, 'GET /manifest.json': never, 'POST /markdown': never }
  ACTIONS: { 'default /login': never }
  LINKS: Record<string, never>
  Params: { uid: never, tab: never, page: never, id: never, code: never, major: never, yearTier: never, subject: never, document: never, week: never, group: never, ticket: never, bypass_oauth: never, token: never, number: never, q: never, email: never, componentName: never, qrcode: never, entity: never }
}
