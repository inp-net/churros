/*
  ...
  - A unique constraint covering the columns `[uid]` on the table `StudentAssociation` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "StudentAssociation" ADD COLUMN     "description" VARCHAR(255) NOT NULL DEFAULT '',
...
-- CreateIndex
CREATE UNIQUE INDEX "StudentAssociation_uid_key" ON "StudentAssociation"("uid");
