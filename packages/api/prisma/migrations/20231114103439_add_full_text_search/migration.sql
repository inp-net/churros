...
-- AlterTable
ALTER TABLE "Article" ADD COLUMN     "search" tsvector NOT NULL DEFAULT ''::tsvector,
...
-- AlterTable
ALTER TABLE "Event" ADD COLUMN     "search" tsvector NOT NULL DEFAULT ''::tsvector,
...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "search" tsvector NOT NULL DEFAULT ''::tsvector,
