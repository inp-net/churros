...
-- AlterTable
ALTER TABLE "Article" ADD COLUMN     "notifiedAt" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
...
-- AlterTable
ALTER TABLE "Event" ADD COLUMN     "notifiedAt" TIMESTAMP(3) DEFAULT CURRENT_TIMESTAMP,
