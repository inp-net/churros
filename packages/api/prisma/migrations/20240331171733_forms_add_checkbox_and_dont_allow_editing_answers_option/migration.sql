...
-- AlterTable
ALTER TABLE "Form" ADD COLUMN     "allowEditingAnswers" BOOLEAN NOT NULL DEFAULT true,
ADD COLUMN     "enableAnswersCompletionCheckbox" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateTable
CREATE TABLE "_formsWithMarkedCheckbox" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateIndex
CREATE UNIQUE INDEX "_formsWithMarkedCheckbox_AB_unique" ON "_formsWithMarkedCheckbox"("A", "B");

-- CreateIndex
CREATE INDEX "_formsWithMarkedCheckbox_B_index" ON "_formsWithMarkedCheckbox"("B");

-- AddForeignKey
ALTER TABLE "_formsWithMarkedCheckbox" ADD CONSTRAINT "_formsWithMarkedCheckbox_A_fkey" FOREIGN KEY ("A") REFERENCES "Form"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_formsWithMarkedCheckbox" ADD CONSTRAINT "_formsWithMarkedCheckbox_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
