/*
  ...
  - Added the required column `groupId` to the `Form` table without a default value. This is not possible if the table is not empty.
  - Added the required column `visibility` to the `Form` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Form" ADD COLUMN     "groupId" TEXT NOT NULL,
ADD COLUMN     "visibility" "Visibility" NOT NULL,
ALTER COLUMN "id" SET DEFAULT nanoid('form:');
