...
ALTER TYPE "CredentialType" ADD VALUE 'PublicKey';
ALTER TYPE "CredentialType" ADD VALUE 'PasskeyEnrollmentChallenge';
...
-- AlterTable
ALTER TABLE "Credential" ADD COLUMN     "counter" INTEGER,
