...
-- AlterTable
ALTER TABLE "LydiaAccount" ADD COLUMN     "studentAssociationId" TEXT,
ALTER COLUMN "id" SET DEFAULT nanoid('lydia:'),
...
-- AddForeignKey
ALTER TABLE "LydiaAccount" ADD CONSTRAINT "LydiaAccount_studentAssociationId_fkey" FOREIGN KEY ("studentAssociationId") REFERENCES "StudentAssociation"("id") ON DELETE SET NULL ON UPDATE CASCADE;
