/*
  ...
  - A unique constraint covering the columns `[groupId,uid]` on the table `ShopItem` will be added. If there are existing duplicate values, this will fail.
  - Added the required column `uid` to the `ShopItem` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "ShopItem" ADD COLUMN     "uid" TEXT NOT NULL,
ALTER COLUMN "id" SET DEFAULT nanoid('shopitem:');
