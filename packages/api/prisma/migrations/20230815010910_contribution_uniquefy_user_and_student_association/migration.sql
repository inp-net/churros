/*
  ...
  - A unique constraint covering the columns `[userId,studentAssociationId]` on the table `Contribution` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Contribution_userId_studentAssociationId_key" ON "Contribution"("userId", "studentAssociationId");
