/*
  ...
  - A unique constraint covering the columns `[moodleId]` on the table `Subject` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "Subject" ADD COLUMN     "moodleId" VARCHAR(255),
...
-- CreateIndex
CREATE UNIQUE INDEX "TeachingUnit_moodleId_key" ON "TeachingUnit"("moodleId");

-- CreateIndex
CREATE UNIQUE INDEX "Subject_moodleId_key" ON "Subject"("moodleId");
