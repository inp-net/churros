/*
  ...
  - You are about to drop the column `draft` on the `Event` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Event" DROP COLUMN "draft",
ADD COLUMN     "draftStep" "EventDraftStep",
