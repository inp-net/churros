/*
  ...
  - You are about to drop the column `authorId` on the `TicketGroup` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "TicketGroup" DROP COLUMN "authorId",
