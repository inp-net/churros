...
-- CreateTable
CREATE TABLE "ThirdPartyCredential" (
    "id" TEXT NOT NULL DEFAULT nanoid('token:'),
    ...
    CONSTRAINT "ThirdPartyCredential_pkey" PRIMARY KEY ("id")
);

-- AddForeignKey
ALTER TABLE "ThirdPartyCredential" ADD CONSTRAINT "ThirdPartyCredential_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
