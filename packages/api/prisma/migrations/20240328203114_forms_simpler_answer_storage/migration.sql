/*
  ...
  - You are about to drop the column `defaultNumber` on the `Question` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Answer" DROP COLUMN "number",
...
-- AlterTable
ALTER TABLE "Question" DROP COLUMN "defaultNumber",
ALTER COLUMN "id" SET DEFAULT nanoid('question:');
