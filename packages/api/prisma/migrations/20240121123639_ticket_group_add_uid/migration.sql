/*
  ...
  - A unique constraint covering the columns `[eventId,uid]` on the table `TicketGroup` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "TicketGroup_eventId_uid_key" ON "TicketGroup"("eventId", "uid");
