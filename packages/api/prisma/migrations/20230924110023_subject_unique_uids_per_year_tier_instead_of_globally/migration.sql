/*
  ...
  - A unique constraint covering the columns `[uid,yearTier]` on the table `Subject` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Subject_uid_yearTier_key" ON "Subject"("uid", "yearTier");
