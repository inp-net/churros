/*
  ...
  - You are about to drop the column `anonymousAnswers` on the `Form` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Form" DROP COLUMN "anonymousAnswers",
