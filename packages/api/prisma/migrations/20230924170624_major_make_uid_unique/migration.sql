/*
  ...
  - A unique constraint covering the columns `[uid,yearTier,forApprentices,semester]` on the table `Subject` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Subject_uid_yearTier_forApprentices_semester_key" ON "Subject"("uid", "yearTier", "forApprentices", "semester");
