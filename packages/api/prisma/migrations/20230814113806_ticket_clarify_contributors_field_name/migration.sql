/*
  ...
  - You are about to drop the column `openToNonAEContributors` on the `Ticket` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Ticket" RENAME COLUMN "openToNonAEContributors"
TO     "openToContributors";
