...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "cededImageRightsToTVn7" BOOLEAN NOT NULL DEFAULT false,
ALTER COLUMN "id" SET DEFAULT nanoid('u:');

-- AlterTable
ALTER TABLE "UserCandidate" ADD COLUMN     "cededImageRightsToTVn7" BOOLEAN NOT NULL DEFAULT false,
