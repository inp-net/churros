/*
  ...
  - You are about to drop the column `uid` on the `LydiaAccount` table. All the data in the column will be lost.

*/
-- DropIndex
DROP INDEX "LydiaAccount_uid_key";
...
-- AlterTable
ALTER TABLE "LydiaAccount" DROP COLUMN "uid",
