...
-- AddForeignKey
ALTER TABLE "Contribution" ADD CONSTRAINT "Contribution_studentAssociationId_fkey" FOREIGN KEY ("studentAssociationId") REFERENCES "StudentAssociation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
