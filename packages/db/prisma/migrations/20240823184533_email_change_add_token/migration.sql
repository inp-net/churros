/*
  ...
  - A unique constraint covering the columns `[token]` on the table `EmailChange` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "EmailChange" ADD COLUMN     "token" TEXT NOT NULL DEFAULT nanoid('', 30),
ALTER COLUMN "id" SET DEFAULT nanoid('emailchange:');
