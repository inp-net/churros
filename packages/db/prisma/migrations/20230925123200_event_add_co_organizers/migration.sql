...
-- CreateTable
CREATE TABLE "_coOrganizer" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateIndex
CREATE UNIQUE INDEX "_coOrganizer_AB_unique" ON "_coOrganizer"("A", "B");

-- CreateIndex
CREATE INDEX "_coOrganizer_B_index" ON "_coOrganizer"("B");

-- AddForeignKey
ALTER TABLE "_coOrganizer" ADD CONSTRAINT "_coOrganizer_A_fkey" FOREIGN KEY ("A") REFERENCES "Event"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_coOrganizer" ADD CONSTRAINT "_coOrganizer_B_fkey" FOREIGN KEY ("B") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;
