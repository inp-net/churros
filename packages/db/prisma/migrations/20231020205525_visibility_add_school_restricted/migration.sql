/*
  ...
  - The values [Restricted] on the enum `Visibility` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
-- CREATE TYPE "Visibility_new" AS ENUM ('Private', 'Unlisted', 'GroupRestricted', 'SchoolRestricted', 'Public');
-- ALTER TABLE "Article" ALTER COLUMN "visibility" DROP DEFAULT;
-- ALTER TABLE "Article" ALTER COLUMN "visibility" TYPE "Visibility_new" USING ("visibility"::text::"Visibility_new");
-- ALTER TABLE "Event" ALTER COLUMN "visibility" TYPE "Visibility_new" USING ("visibility"::text::"Visibility_new");
-- ALTER TYPE "Visibility" RENAME TO "Visibility_old";
-- ALTER TYPE "Visibility_new" RENAME TO "Visibility";
-- DROP TYPE "Visibility_old";
-- ALTER TABLE "Article" ALTER COLUMN "visibility" SET DEFAULT 'Private';
ALTER TYPE "Visibility" RENAME VALUE 'Restricted' TO 'GroupRestricted';
ALTER TYPE "Visibility" ADD VALUE 'SchoolRestricted';
COMMIT;
