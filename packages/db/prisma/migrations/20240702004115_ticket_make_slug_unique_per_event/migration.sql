/*
  ...
  - A unique constraint covering the columns `[eventId,slug]` on the table `Ticket` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Ticket_eventId_slug_key" ON "Ticket"("eventId", "slug");
