-- CreateEnum
CREATE TYPE "PayPalTransactionStatus" AS ENUM ('Created', 'Saved', 'Approved', 'Voided', 'Completed', 'PayerActionRequired');
...
-- AlterTable
ALTER TABLE "PaypalTransaction" ADD COLUMN     "status" "PayPalTransactionStatus",
ALTER COLUMN "id" SET DEFAULT nanoid('paypalpayment:');
