/*
  ...
  - A unique constraint covering the columns `[inviteCode]` on the table `Ticket` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "Ticket" ADD COLUMN     "inviteCode" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "Ticket_inviteCode_key" ON "Ticket"("inviteCode");
