-- CreateEnum
CREATE TYPE "PromotionType" AS ENUM ('SIMPPS');
...
CREATE TABLE "PromotionCode" (
    "id" TEXT NOT NULL DEFAULT nanoid('promocode:'),
...
CREATE TABLE "Promotion" (
    "id" TEXT NOT NULL DEFAULT nanoid('promo:'),
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "_PromotionToTicket" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_PromotionToTicket_AB_unique" ON "_PromotionToTicket"("A", "B");

-- CreateIndex
CREATE INDEX "_PromotionToTicket_B_index" ON "_PromotionToTicket"("B");

-- AddForeignKey
ALTER TABLE "PromotionCode" ADD CONSTRAINT "PromotionCode_claimedById_fkey" FOREIGN KEY ("claimedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PromotionCode" ADD CONSTRAINT "PromotionCode_promotionId_fkey" FOREIGN KEY ("promotionId") REFERENCES "Promotion"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_PromotionToTicket" ADD CONSTRAINT "_PromotionToTicket_A_fkey" FOREIGN KEY ("A") REFERENCES "Promotion"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_PromotionToTicket" ADD CONSTRAINT "_PromotionToTicket_B_fkey" FOREIGN KEY ("B") REFERENCES "Ticket"("id") ON DELETE CASCADE ON UPDATE CASCADE;
