-- ReorderEnum (prisma does not do this, i did it by hand...)
begin;
ALTER TYPE "GroupType" RENAME TO "GroupType_old";
CREATE TYPE "GroupType_new" AS ENUM ('StudentAssociationSection', 'List', 'Association', 'Club', 'Integration', 'Group');
