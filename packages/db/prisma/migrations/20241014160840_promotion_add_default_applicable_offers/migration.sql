...
-- CreateTable
CREATE TABLE "_defaultApplicableOffers" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateIndex
CREATE UNIQUE INDEX "_defaultApplicableOffers_AB_unique" ON "_defaultApplicableOffers"("A", "B");

-- CreateIndex
CREATE INDEX "_defaultApplicableOffers_B_index" ON "_defaultApplicableOffers"("B");

-- AddForeignKey
ALTER TABLE "_defaultApplicableOffers" ADD CONSTRAINT "_defaultApplicableOffers_A_fkey" FOREIGN KEY ("A") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_defaultApplicableOffers" ADD CONSTRAINT "_defaultApplicableOffers_B_fkey" FOREIGN KEY ("B") REFERENCES "Promotion"("id") ON DELETE CASCADE ON UPDATE CASCADE;
