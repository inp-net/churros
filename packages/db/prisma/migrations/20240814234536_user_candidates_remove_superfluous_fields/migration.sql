/*
  ...
  - You are about to drop the column `address` on the `UserCandidate` table. All the data in the column will be lost.
  - You are about to drop the column `phone` on the `UserCandidate` table. All the data in the column will be lost.
  - You are about to drop the column `schoolEmail` on the `UserCandidate` table. All the data in the column will be lost.
  - You are about to drop the column `schoolServer` on the `UserCandidate` table. All the data in the column will be lost.
  - You are about to drop the column `schoolUid` on the `UserCandidate` table. All the data in the column will be lost.

*/
-- DropIndex
DROP INDEX "UserCandidate_schoolEmail_key";

-- DropIndex
DROP INDEX "UserCandidate_schoolServer_schoolUid_key";
...
-- AlterTable
ALTER TABLE "LydiaTransaction" ADD COLUMN     "paidCallback" TEXT,
...
-- AlterTable
ALTER TABLE "UserCandidate" DROP COLUMN "address",
DROP COLUMN "phone",
DROP COLUMN "schoolEmail",
DROP COLUMN "schoolServer",
DROP COLUMN "schoolUid",
ALTER COLUMN "id" SET DEFAULT nanoid('candidate:');
