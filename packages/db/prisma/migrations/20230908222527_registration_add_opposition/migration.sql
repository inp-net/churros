...
-- AlterTable
ALTER TABLE "Registration" ADD COLUMN     "opposedAt" TIMESTAMP(3),
ADD COLUMN     "opposedById" TEXT,
...
-- AddForeignKey
ALTER TABLE "Registration" ADD CONSTRAINT "Registration_opposedById_fkey" FOREIGN KEY ("opposedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
