...
-- AlterTable
ALTER TABLE "LydiaTransaction" ADD COLUMN     "studentAssociationId" TEXT,
...
-- AddForeignKey
ALTER TABLE "LydiaTransaction" ADD CONSTRAINT "LydiaTransaction_studentAssociationId_fkey" FOREIGN KEY ("studentAssociationId") REFERENCES "StudentAssociation"("id") ON DELETE SET NULL ON UPDATE CASCADE;
