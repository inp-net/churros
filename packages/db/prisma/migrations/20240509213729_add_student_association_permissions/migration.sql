/*
  ...
  - You are about to drop the column `canEditGroups` on the `User` table. All the data in the column will be lost.
  - You are about to drop the column `canEditUsers` on the `User` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "User" DROP COLUMN "canEditGroups",
DROP COLUMN "canEditUsers",
...
-- CreateTable
CREATE TABLE "_studentAssociationGroupsEditor" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateIndex
CREATE UNIQUE INDEX "_studentAssociationGroupsEditor_AB_unique" ON "_studentAssociationGroupsEditor"("A", "B");

-- CreateIndex
CREATE INDEX "_studentAssociationGroupsEditor_B_index" ON "_studentAssociationGroupsEditor"("B");

-- AddForeignKey
ALTER TABLE "_studentAssociationGroupsEditor" ADD CONSTRAINT "_studentAssociationGroupsEditor_A_fkey" FOREIGN KEY ("A") REFERENCES "StudentAssociation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_studentAssociationGroupsEditor" ADD CONSTRAINT "_studentAssociationGroupsEditor_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
