/*
  ...
  - You are about to drop the column `moodleId` on the `Subject` table. All the data in the column will be lost.
  - You are about to drop the column `moodleId` on the `TeachingUnit` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Subject" RENAME COLUMN "moodleId" TO "apogeeCode";
ALTER TABLE "Subject" ALTER COLUMN "id" SET DEFAULT nanoid('subj:');

-- AlterTable
ALTER TABLE "TeachingUnit" RENAME COLUMN "moodleId" TO "apogeeCode"; 
