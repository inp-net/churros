...
-- AlterTable
ALTER TABLE "Ticket" RENAME COLUMN "price" TO "minimumPrice";
ALTER TABLE "Ticket"
ADD COLUMN     "maximumPrice" DOUBLE PRECISION NOT NULL DEFAULT 0,
ALTER COLUMN "id" SET DEFAULT nanoid('t:');

-- Set maximum price to minimum price
UPDATE "Ticket" SET "maximumPrice" = "minimumPrice";
