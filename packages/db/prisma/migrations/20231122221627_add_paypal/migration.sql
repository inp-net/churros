...
CREATE TABLE "PaypalTransaction" (
    "id" TEXT NOT NULL DEFAULT nanoid('paypalpayment:'),
...
-- CreateIndex
CREATE UNIQUE INDEX "PaypalTransaction_registrationId_key" ON "PaypalTransaction"("registrationId");

-- AddForeignKey
ALTER TABLE "PaypalTransaction" ADD CONSTRAINT "PaypalTransaction_registrationId_fkey" FOREIGN KEY ("registrationId") REFERENCES "Registration"("id") ON DELETE CASCADE ON UPDATE CASCADE;
