...
-- AlterTable
ALTER TABLE "Comment" ADD COLUMN     "replyThreadRootId" TEXT,
ALTER COLUMN "id" SET DEFAULT nanoid('comment:');
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_replyThreadRootId_fkey" FOREIGN KEY ("replyThreadRootId") REFERENCES "Comment"("id") ON DELETE SET NULL ON UPDATE CASCADE;
