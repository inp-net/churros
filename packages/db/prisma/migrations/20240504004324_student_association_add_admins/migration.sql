...
-- CreateTable
CREATE TABLE "_studentAssociationAdmins" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateIndex
CREATE UNIQUE INDEX "_studentAssociationAdmins_AB_unique" ON "_studentAssociationAdmins"("A", "B");

-- CreateIndex
CREATE INDEX "_studentAssociationAdmins_B_index" ON "_studentAssociationAdmins"("B");

-- AddForeignKey
ALTER TABLE "_studentAssociationAdmins" ADD CONSTRAINT "_studentAssociationAdmins_A_fkey" FOREIGN KEY ("A") REFERENCES "StudentAssociation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_studentAssociationAdmins" ADD CONSTRAINT "_studentAssociationAdmins_B_fkey" FOREIGN KEY ("B") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
