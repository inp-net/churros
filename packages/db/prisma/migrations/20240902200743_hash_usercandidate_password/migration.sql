/*
  ...
  - You are about to drop the column `password` on the `UserCandidate` table. All the data in the column will be lost.
  - Added the required column `churrosPassword` to the `UserCandidate` table without a default value. This is not possible if the table is not empty.
  - Added the required column `ldapPassword` to the `UserCandidate` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "UserCandidate" DROP COLUMN "password",
ADD COLUMN     "churrosPassword" VARCHAR(255) NOT NULL,
ADD COLUMN     "ldapPassword" VARCHAR(255) NOT NULL,
