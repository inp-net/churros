/*
  ...
  - You are about to drop the `BarWeek` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_BarWeekToGroup` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "_BarWeekToGroup" DROP CONSTRAINT "_BarWeekToGroup_A_fkey";

-- DropForeignKey
ALTER TABLE "_BarWeekToGroup" DROP CONSTRAINT "_BarWeekToGroup_B_fkey";
