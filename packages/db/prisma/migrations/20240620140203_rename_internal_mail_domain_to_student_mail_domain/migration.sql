/*
  ...
  - You are about to drop the column `internalMailDomain` on the `School` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "School" RENAME COLUMN "internalMailDomain" TO "studentMailDomain";
ALTER TABLE "School" ALTER COLUMN "id" SET DEFAULT nanoid('school:');
ALTER TABLE "School" ALTER COLUMN "aliasMailDomains" SET DEFAULT ARRAY[]::VARCHAR(255)[];
