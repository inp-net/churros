...
-- AlterTable
ALTER TABLE "Major" ADD COLUMN     "ldapSchoolUid" VARCHAR(255),
...
-- AddForeignKey
ALTER TABLE "Major" ADD CONSTRAINT "Major_ldapSchoolUid_fkey" FOREIGN KEY ("ldapSchoolUid") REFERENCES "School"("uid") ON DELETE SET NULL ON UPDATE CASCADE;
