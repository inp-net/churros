-- DropForeignKey
ALTER TABLE "LydiaTransaction" DROP CONSTRAINT "LydiaTransaction_studentAssociationContributionId_fkey";
...
-- AddForeignKey
ALTER TABLE "LydiaTransaction" ADD CONSTRAINT "LydiaTransaction_studentAssociationContributionId_fkey" FOREIGN KEY ("studentAssociationContributionId") REFERENCES "Contribution"("id") ON DELETE CASCADE ON UPDATE CASCADE;
