...
-- AlterTable
ALTER TABLE "EventManagerInvite" ADD COLUMN     "canEdit" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "canEditPermissions" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "canVerifyRegistrations" BOOLEAN NOT NULL DEFAULT true,
ALTER COLUMN "id" SET DEFAULT nanoid('eminvite:');
