-- AlterEnum
ALTER TYPE "CredentialType" ADD VALUE 'GroupAccessToken';
...
-- AlterTable
ALTER TABLE "Credential" ADD COLUMN     "groupId" TEXT,
...
-- AddForeignKey
ALTER TABLE "Credential" ADD CONSTRAINT "Credential_groupId_fkey" FOREIGN KEY ("groupId") REFERENCES "Group"("id") ON DELETE CASCADE ON UPDATE CASCADE;
