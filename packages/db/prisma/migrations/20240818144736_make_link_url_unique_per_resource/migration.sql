/*
  ...
  - A unique constraint covering the columns `[userId,value]` on the table `Link` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[studentAssociationId,value]` on the table `Link` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[groupId,value]` on the table `Link` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[articleId,value]` on the table `Link` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[eventId,value]` on the table `Link` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[ticketId,value]` on the table `Link` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[notificationId,value]` on the table `Link` will be added. If there are existing duplicate values, this will fail.
  - A unique constraint covering the columns `[subjectId,value]` on the table `Link` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Link_userId_value_key" ON "Link"("userId", "value");

-- CreateIndex
CREATE UNIQUE INDEX "Link_studentAssociationId_value_key" ON "Link"("studentAssociationId", "value");

-- CreateIndex
CREATE UNIQUE INDEX "Link_groupId_value_key" ON "Link"("groupId", "value");

-- CreateIndex
CREATE UNIQUE INDEX "Link_articleId_value_key" ON "Link"("articleId", "value");

-- CreateIndex
CREATE UNIQUE INDEX "Link_eventId_value_key" ON "Link"("eventId", "value");

-- CreateIndex
CREATE UNIQUE INDEX "Link_ticketId_value_key" ON "Link"("ticketId", "value");

-- CreateIndex
CREATE UNIQUE INDEX "Link_notificationId_value_key" ON "Link"("notificationId", "value");

-- CreateIndex
CREATE UNIQUE INDEX "Link_subjectId_value_key" ON "Link"("subjectId", "value");
