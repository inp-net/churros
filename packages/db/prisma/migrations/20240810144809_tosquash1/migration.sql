/*
  ...
  - You are about to drop the column `beneficiary` on the `Registration` table. All the data in the column will be lost.

*/
-- AlterEnum
ALTER TYPE "NotificationChannel" ADD VALUE 'Mandatory';
...
-- AlterTable
ALTER TABLE "Registration" RENAME COLUMN "beneficiary" TO "externalBeneficiary";
ALTER TABLE "Registration" ADD COLUMN     "internalBeneficiaryId" TEXT,
...
-- AlterTable
ALTER TABLE "User" ADD COLUMN     "lydiaPhone" VARCHAR(255) NOT NULL DEFAULT '',
...
-- AddForeignKey
ALTER TABLE "Registration" ADD CONSTRAINT "Registration_internalBeneficiaryId_fkey" FOREIGN KEY ("internalBeneficiaryId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
