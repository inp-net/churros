/*
  ...
  - You are about to drop the `_PromotionToTicket` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE "_PromotionToTicket" DROP CONSTRAINT "_PromotionToTicket_A_fkey";

-- DropForeignKey
ALTER TABLE "_PromotionToTicket" DROP CONSTRAINT "_PromotionToTicket_B_fkey";
...
-- AlterTable
ALTER TABLE "Ticket" ADD COLUMN     "promotionId" TEXT,
