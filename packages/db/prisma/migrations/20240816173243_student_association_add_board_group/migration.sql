/*
  ...
  - A unique constraint covering the columns `[boardId]` on the table `StudentAssociation` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "Group" ADD COLUMN     "boardOfId" TEXT,
...
-- AlterTable
ALTER TABLE "StudentAssociation" ADD COLUMN     "boardId" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "StudentAssociation_boardId_key" ON "StudentAssociation"("boardId");

-- AddForeignKey
ALTER TABLE "StudentAssociation" ADD CONSTRAINT "StudentAssociation_boardId_fkey" FOREIGN KEY ("boardId") REFERENCES "Group"("id") ON DELETE SET NULL ON UPDATE CASCADE;
